...
- db/
  ...
  - schema.sql: schema aligned with SCHEMA_OVERVIEW.md.
  ...
  - backfill_acceptance_and_term.py: backfill term/acceptance_date when missing.
...
1) 2026 cohort:
   - term = "Fall 2026" OR accepted applicants notified in 2026
     (acceptance_date or date_added in 2026).
   This captures "Fall 2026" start term entries plus 2026 acceptances even
   when the term is missing.
